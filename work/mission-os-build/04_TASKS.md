...
- T-001: [x] Implement OS scaffold command
...
- T-002: [x] Implement boundary-check command
...
- T-003: [x] Implement status command
...
- T-004: [x] Integrate scripts into package + docs
...
- Current step: slice-1 implementation complete, pending review PR to `main`
